...
public class books {
    ...
    public books(String endpoint, String title, String author, String thumb, String theme, String description, String type, float rating, float rate_count, int status, int search_number, long view) {
